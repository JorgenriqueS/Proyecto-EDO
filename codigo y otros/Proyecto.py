...
tab.column("#1", width = 50, anchor = CENTER)
...
tab.column("#6", width = 110, anchor = CENTER)
...
def llenarTabla(tree, lX, lRk1, lRk2, lRK4, real, lErr):
    ...
    #aproximando los numeros decimales de cada lista
    listas = [lRk1, lRk2, lRK4, real, lErr]
