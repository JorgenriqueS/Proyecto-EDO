...
def main():
    ...
    pestaña1.iconbitmap("Proyecto-EDO\galileo.ico")
    ...
    entry_fu = Entry(pestaña1, width = 152).place(x = 85, y = 127)
    ...
    def grafica(eje_x, listaReal, rk1, rk2, rk4, s):
        ...
        fig.set_title('Curva Real y Aproximada')
        fig.set_xlabel('X')
        fig.set_ylabel('Y')
        fig.legend()
        gen.draw()
    ...
    imagen = Image.open("Proyecto-EDO\logo2.png")  
